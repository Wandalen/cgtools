...
|------|---------|-------------|----------:|
| `adr/` | Accepted ecosystem-level architecture decisions and their alternatives | [adr/readme.md](../adr/readme.md) | 6 |
...
| adr | 004 | Native Vulkan HAL Backend | [adr/004_native_vulkan_hal_backend.md](../adr/004_native_vulkan_hal_backend.md) |
| adr | 005 | Windowed Native Presentation | [adr/005_windowed_native_presentation.md](../adr/005_windowed_native_presentation.md) |
| adr | 006 | Vulkan Windowed Presentation | [adr/006_vulkan_windowed_presentation.md](../adr/006_vulkan_windowed_presentation.md) |
