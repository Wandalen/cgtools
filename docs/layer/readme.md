...
| 002 | [L1 GPU Hardware Abstraction](002_l1_gpu_hal.md) | One API over all drivers — contract decided, build gated on explorations/001 | `gpu_hal` (reserved) | ⏸️ reserved |
