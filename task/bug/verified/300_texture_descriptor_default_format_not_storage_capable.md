...
- **Fix Task:** [359](../../verifying/359_minwebgpu_texture_descriptor_default_format_fix_registration.md) (task's own Readiness Verification Gate PASS 8/8; blocked on `tsk .verify_pass` actor guard, task remains 🔬 Verifying)
