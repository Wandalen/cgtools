...
| 2026-08-15 | linked | Filed [BUG-116](../completed/116_query_table_plain_width_wraps_documentation_mismatch.md) as a disclosed follow-up for `table_plain`'s separate, pre-existing wrap/truncate documentation mismatch surfaced by this bug's own Step 10 docs sweep; `**Related Bugs:**` cross-link added to this file's header. |
