...
- **Fold-in (confirmed before this task's execution):** this fix invalidates
  ...
  than left stale:
  - `module/helper/tilemap_renderer/tests/manual/readme.md` (task 251's own
...
| 2026-08-19 22:45:30 | user1@w002/home/user1/pro/lib/yrd_gamedev/cgtools/ | VERIFY_PASS_ATTEMPTED | `tsk .verify_pass 218` → exit 1, "self-verification forbidden (actor matches filed_by)" — same-actor sandbox guard; not forced/spoofed, left at 🔬 Verifying per standing project convention |
...
| 2026-08-20 10:12:00 | user1@w002/home/user1/pro/lib/yrd_gamedev/cgtools/ | VERIFY_PASS_ATTEMPTED | `tsk .verify_pass 218` → exit 1, same-actor guard (unchanged). Round 7 re-confirmation: mechanical drift check clean — bare `docs/feature/005...`/`tests/...` citations are crate-relative shorthand, full paths (`module/helper/tilemap_renderer/docs/feature/005...`, etc.) all resolve |
