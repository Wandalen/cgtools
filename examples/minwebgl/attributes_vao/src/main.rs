...
fn run() -> Result< (), gl::WebglError >
{
  ...
  [
    ...
    -0.6618, -0.7687, 50.0, 1.5849, 0.0600, 0.0662,
    -0.3149, 0.7417, 10.0, 0.9232, 0.9332, 0.4260,
     0.9749, -0.8996, 40.0, 0.6969, 0.5353, 0.1471,
    -0.9202, -0.2956, 90.0, 0.2899, 0.9056, 0.7799,
     0.4550, -0.0642, 20.0, 0.2565, 0.6451, 0.8498,
  ];
  ...
  [
     // position    point size    color
     0.6192, 0.5755, 70.0, 0.6133, 0.8137, 0.4046,
    -0.5946, 0.7057, 20.0, 0.6745, 0.5229, 0.4518,
     0.6365, 0.7236, 70.0, 0.4690, 0.0542, 0.7396,
     0.8625, -0.0835, 20.0, 0.3708, 0.6588, 0.8611,
     0.7997, 0.4695, 70.0, 0.7490, 0.3797, 0.6879,
  ];
