...
extern "C"
{
  ...
  #[ allow( unsafe_code ) ]
  #[ wasm_bindgen( js_name = "addTextController" ) ]
  pub fn add_text( gui : &JsValue, object : &JsValue, property : &str ) -> JsValue;
  ...
  #[ allow( unsafe_code ) ]
  #[ wasm_bindgen( js_name = "onChange" ) ]
  pub fn on_change_str( gui : &JsValue, callback : &Closure< dyn FnMut( String ) > ) -> JsValue;
