...
#![ allow( dead_code ) ]
pub const VAR_CAMERAPOSITION: &'static [u8] = b"cameraPosition";
pub const VAR_CUBENORMALMAP: &'static [u8] = b"m";
pub const VAR_DIAMONDCOLOR: &'static [u8] = b"r";
pub const VAR_DISTANCEATTENUATIONSPEED: &'static [u8] = b"e";
pub const VAR_EMISSIVE_COLOR: &'static [u8] = b"D";
pub const VAR_ENVMAP: &'static [u8] = b"v";
pub const VAR_ENVMAPINTENSITY: &'static [u8] = b"s";
pub const VAR_FRAG_COLOR: &'static [u8] = b"u";
pub const VAR_INVERSERESTMATRIX: &'static [u8] = b"l";
pub const VAR_INVERSEWORLDMATRIX: &'static [u8] = b"inverseWorldMatrix";
pub const VAR_N2: &'static [u8] = b"a";
pub const VAR_RADIUS: &'static [u8] = b"w";
pub const VAR_RAINBOWDELTA: &'static [u8] = b"c";
pub const VAR_RAYBOUNCES: &'static [u8] = b"n";
pub const VAR_RESTMATRIX: &'static [u8] = b"d";
pub const VAR_TRANSPARENTB: &'static [u8] = b"G";
pub const VAR_TRASNPARENTA: &'static [u8] = b"F";
