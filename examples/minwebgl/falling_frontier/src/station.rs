...
impl Station
{
  pub fn new( gl : &gl::GL ) -> Self
  {
    ...
    push_part( gl, &mut parts, station_transform, F32x4x4::identity(), &cylinder_mesh( 4.0, 4.0, 30.0, 12 ), DARK, AMBIENT_LIT );
    ...
    push_part( gl, &mut parts, station_transform, ring, &torus_mesh( 18.0, 1.8, 8, 24 ), METALLIC, AMBIENT_LIT );
    ...
    for i in 0 .. 4
    {
      ...
      push_part( gl, &mut parts, station_transform, spoke, &box_mesh( 16.0, 0.5, 0.75 ), DARK, AMBIENT_LIT );
    }
    ...
    for i in 0 .. 6
    {
      ...
      push_part( gl, &mut parts, station_transform, pos, &cylinder_mesh( 2.0, 2.5, 6.0, 8 ), METALLIC, AMBIENT_LIT );
    }
    ...
    parts.push( HullPart { vao, index_count, model : station_transform * beacon, color : GLOW, ambient : AMBIENT_GLOW } );
