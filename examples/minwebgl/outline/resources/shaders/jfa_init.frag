...
// module/helper/renderer/src/webgl/shaders/post_processing/outline/wide_outline/jfa_init.frag ( naming differs : v_tex_coord here vs vUv there ).
...
void main()
{
  ...
  if ( object_present > 0.0 ) // If pixel is part of the object ( check > 0.0 for robustness )
  {
