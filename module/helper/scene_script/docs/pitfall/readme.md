...
- **In Scope**: Rhai-language scoping surprises; gaps between what `top_level_lint` checks and what the top-level bindings convention actually promises; traps a consumer hits deserializing a script's returned value via `rhai::serde`.
