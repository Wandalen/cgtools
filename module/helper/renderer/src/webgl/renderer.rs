mod private
{
  ...
  use crate::webgl::
  { 
    post_processing::{BlendPass, Pass, SwapFramebuffer, UnrealBloomPass, VS_TRIANGLE}, program::{self, CompositeShader}, AlphaMode, Camera, Node, Object3D, Primitive, ProgramInfo, Scene, IBL
  };
