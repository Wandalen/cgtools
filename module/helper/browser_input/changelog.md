...
- `impl From<&str> for PointerType` — public conversion from a DOM `PointerEvent.pointerType` string to `PointerType`; consistent with `MouseButton::from_button` / `impl From<&str> for KeyboardKey`
