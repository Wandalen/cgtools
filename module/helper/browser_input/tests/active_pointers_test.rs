...
{
  ev( EventType::PointerButton( id, point( x, y ), MouseButton::Main, Action::Press ) )
}

fn release( id : i32, x : i32, y : i32 ) -> Event
{
  ev( EventType::PointerButton( id, point( x, y ), MouseButton::Main, Action::Release ) )
}

fn move_to( id : i32, x : i32, y : i32 ) -> Event
{
  ev( EventType::PointerMove( id, point( x, y ) ) )
}
