...
| File | Relationship |
|------|--------------|
| [pitfall/001_load_time_validation_partially_enforced.md](../pitfall/001_load_time_validation_partially_enforced.md) | `CompileError::UnsupportedSource` is where the anchor↔source compatibility gap actually surfaces to an API caller |
