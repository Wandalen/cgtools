...
mod private
{
  ...
  use crate::resource::{ TintRef, EffectRef, BlendMode };
  use crate::source::SpriteSource;

  /// One textured layer inside an [`crate::object::Object`].
  ///
...
{
  exposed use ObjectLayer;
  exposed use LayerBehaviour;
  exposed use TintBehaviour;
  exposed use MaskTint;
}
