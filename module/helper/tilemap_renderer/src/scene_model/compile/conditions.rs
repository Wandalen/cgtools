...
mod private
{
  use crate::scene_model::compile::neighbors::{ NeighborState, VOID_ID };
  use crate::scene_model::source::Condition;

  /// Evaluate a `Condition` against `neighbour`.
  ///
  /// `current_priority` is the [`crate::scene_model::compile::neighbors::tile_max_priority`]
...
{
  use super::private::*;
  use crate::scene_model::compile::neighbors::NeighborState;
  use crate::scene_model::source::Condition;
