...
mod private
{
  ...
  {
    /// An [`crate::scene_model::compile::AssetResolver`] returned a failure
    ...
    /// An object's `default_animation` isn't present in its `animations` map.
  ...
  impl fmt::Display for CompileError
  {
    ...
    fn fmt( &self, f : &mut fmt::Formatter< '_ > ) -> fmt::Result
    {
      match self
      {
        ...
        Self::MissingDefaultAnimation { object } =>
          write!( f, "object {object:?} has no animation matching its declared default" ),
