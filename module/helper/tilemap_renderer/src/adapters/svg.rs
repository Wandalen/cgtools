...
struct SvgGeometry {
    // Will be populated when implementing meshes
}
...
enum SvgBatch {
    ...
    Mesh {
        ...
        geometry: ResourceId<asset::Geometry>,
        fill: FillRef,
            ...
            match cmd {
                ...
                RenderCommand::CubicTo(c) => {
                    let _ = write!(
                        self.path_data,
                        "C {} {} {} {} {} {} ",
                        c.c1x, c.c1y, c.c2x, c.c2y, c.x, c.y
                    );
                }
                RenderCommand::ArcTo(a) => {
                    let _ = write!(
                        self.path_data,
                        "A {} {} {} {} {} {} {} ",
                        a.rx, a.ry, a.rotation, a.large_arc as u8, a.sweep as u8, a.x, a.y
                    );
                }
