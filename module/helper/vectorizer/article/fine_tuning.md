...
<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/1_problem.jpg" width="500px">
</p>

The outline is very rough, which causes holes to appear during the tracing process:

<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/1_problem2.jpg" width="500px">
</p>
...
<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/outline.jpg" width="500px">
</p>

The solution is to trace holes in clockwise direction and then reverse the path.

<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/1_solution.jpg" width="500px">
</p>
...
<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/2_problem.jpg" width="500px">
</p>
...
<p align="center">
<img src="https://huggingface.co/datasets/cgtools/assets/resolve/main/img/vectorizer/article/fine_tuning/2_solution.jpg" width="500px">
</p>
