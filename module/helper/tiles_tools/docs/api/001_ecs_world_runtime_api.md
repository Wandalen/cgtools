...
- **Out of Scope**: `MovementSystem::process_movement` and the other `ecs::systems` types callable directly but not wired into `World::update`'s automatic dispatch; individual component definitions (see `type/002`).
