...
| ID | Case | Real Test |
|----|------|-----------|
| TC-1 | Positive value: slices/truncates as documented | `shader_chunks_test.rs::query_offset_and_limit_page_the_result` (`limit`, `offset`); `shader_chunks_test.rs::query_markdown_format_renders_pipe_table_with_heading_and_width` (`width`) |
| TC-2 | Zero (reserved default): unlimited / no-skip / auto-width | `shader_chunks_test.rs::query_list_defaults_renders_all_four_chunks_as_plain_table` |
