...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | Non-empty heading renders as a rule line above the markdown table | `shader_chunks_test.rs::query_markdown_format_renders_pipe_table_with_heading_and_width` |
| EC-2 | Empty (default): no heading line emitted | `shader_chunks_test.rs::query_list_defaults_renders_all_four_chunks_as_plain_table` |
