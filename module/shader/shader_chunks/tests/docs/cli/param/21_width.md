...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | `width::N` truncates over-long cells with `...` in table/markdown | `shader_chunks_test.rs::query_markdown_format_renders_pipe_table_with_heading_and_width` |
| EC-2 | `0` (default): automatic column sizing | `shader_chunks_test.rs::query_list_defaults_renders_all_four_chunks_as_plain_table` |
