...
- **Purpose:** Edge-case test specifications for every parameter `shader_chunks` accepts.
...
- **Out of Scope:** Group-level interaction scenarios (→ [`../param_group/`](../param_group/readme.md)); command-level integration scenarios (→ [`../command/`](../command/readme.md)); type-level construction/parsing (→ [`../type/`](../type/readme.md)).
