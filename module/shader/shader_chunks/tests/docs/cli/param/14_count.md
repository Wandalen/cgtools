...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | Reports the filtered total, computed before `limit::`/`offset::` paging | `shader_chunks_test.rs::query_count_reports_filtered_total_before_paging` |
| EC-2 | End-to-end: bare `count::1` prints `4` and nothing else | `cli_subprocess_test.rs::list_filters_and_formats_via_named_params` |
