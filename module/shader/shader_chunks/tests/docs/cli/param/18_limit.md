...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | `limit::N` keeps at most N rows, applied after sort and offset | `shader_chunks_test.rs::query_offset_and_limit_page_the_result` |
| EC-2 | `0` means unlimited (the default) | `shader_chunks_test.rs::query_list_defaults_renders_all_four_chunks_as_plain_table` |
