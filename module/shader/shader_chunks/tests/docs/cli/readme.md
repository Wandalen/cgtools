...
- **Purpose:** Test specifications for `shader_chunks`, organized by testing lens (parameter, command, command group, type) rather than by test file.
