...
|------|------|--------|-------------|
| 1 | Parameter edge cases | `EC-N` | query, compose, preview, render |
| 2 | Group-interaction corner cases | `GRP-N` | query only |
| 3 | Per-command integration | `INT-N` / `PAR-N` | all 6 leaves |
| 4 | Cross-command group invariants + workflows | `CG-N` / `WF-N` | all 6 leaves |
| 5 | Type construction/parsing/rejection | `TC-N` | query, render |

Tier 2 exists only for `shader_chunks_query`: the shared 20-named-parameter
...
| [`shader_chunks_compose`](../../../../shader_chunks_compose/tests/docs/cli/readme.md) | [param/](../../../../shader_chunks_compose/tests/docs/cli/param/readme.md) | — | [command/](../../../../shader_chunks_compose/tests/docs/cli/command/readme.md) | [command_group/](../../../../shader_chunks_compose/tests/docs/cli/command_group/readme.md) | — |
...
| [`shader_chunks_validate`](../../../../shader_chunks_validate/tests/docs/cli/readme.md) | — | — | [command/](../../../../shader_chunks_validate/tests/docs/cli/command/readme.md) | [command_group/](../../../../shader_chunks_validate/tests/docs/cli/command_group/readme.md) | — |
...
|------|-------|------------|---------------------|
| param/ | 31 | 140 `EC-N` | [query](../../../../shader_chunks_query/tests/docs/cli/readme.md#aggregate-test-counts) · [compose](../../../../shader_chunks_compose/tests/docs/cli/readme.md#aggregate-test-counts) · [preview](../../../../shader_chunks_preview/tests/docs/cli/readme.md#aggregate-test-counts) · [render](../../../../shader_chunks_render/tests/docs/cli/readme.md#aggregate-test-counts) |
| param_group/ | 3 | 16 `GRP-N` | [query](../../../../shader_chunks_query/tests/docs/cli/readme.md#aggregate-test-counts) |
| command/ | 9 | 44 `PAR-N` + 43 `INT-N` | all 6 leaves, see [Per-Leaf Tier Coverage](#per-leaf-tier-coverage) above |
| command_group/ | 7 | 45 `CG-N` + 3 `WF-N` | all 6 leaves, see [Per-Leaf Tier Coverage](#per-leaf-tier-coverage) above |
| type/ | 13 | 71 `TC-N` | [query](../../../../shader_chunks_query/tests/docs/cli/readme.md#aggregate-test-counts) · [render](../../../../shader_chunks_render/tests/docs/cli/readme.md#aggregate-test-counts) |
...
- [`shader_chunks_compose/tests/docs/cli/`](../../../../shader_chunks_compose/tests/docs/cli/readme.md) — Tiers 1, 3-4 (`compose`)
...
- [`shader_chunks_validate/tests/docs/cli/`](../../../../shader_chunks_validate/tests/docs/cli/readme.md) — Tiers 3-4 (`validate`)
