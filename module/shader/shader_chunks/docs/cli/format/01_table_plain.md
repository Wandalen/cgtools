...
| 4 | [.tunables](../command/06_tunables.md) | When the chunk declares ≥1 parameter; columns: name, kind, type, range, source — a chunk with zero declared parameters prints a one-line message instead |
