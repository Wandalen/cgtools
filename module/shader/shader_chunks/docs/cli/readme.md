...
chunks bundled by [`shader_chunks_core`](../../../shader_chunks_core/readme.md).
...
**Design Completeness:** All required L1-L3 entities present for a 5-command, single-domain-object CLI; no incomplete-content placeholders; every command/param/type/format instance has full required content and cross-references.
