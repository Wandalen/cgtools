...
| ID | Case | Real Test |
|----|------|-----------|
| PAR-1 | Valid, known chunk name (`hash21`) | `shader_chunks_cli_test.rs::get_chunk_reports_full_detail_for_hash21`; `cli_subprocess_test.rs::get_hash21_prints_full_detail` |
| PAR-2 | Unknown chunk name | `shader_chunks_cli_test.rs::get_chunk_reports_unknown_chunk_error_for_bogus_name`; `cli_subprocess_test.rs::get_unknown_chunk_exits_non_zero_without_a_panic_backtrace` |
