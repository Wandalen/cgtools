...
|--------|-------|
| Type cases | 5 |
| Real test functions referenced | 10 |
| Off state | TC-1 |
| On state | TC-2 (6 of 7 switch params exercised via explicit `::1`) |
