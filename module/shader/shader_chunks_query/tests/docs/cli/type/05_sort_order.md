...
| TC-3 | Behavioral: `Desc` reverses every sort key's result — including `input` | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_order_desc_reverses_including_input_order` |
