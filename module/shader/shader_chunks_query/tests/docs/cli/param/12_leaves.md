...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | `leaves::1` selects exactly the chunks with no dependencies | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_roots_and_leaves_select_graph_extremes` |
