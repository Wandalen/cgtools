...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | `offset::N` skips the first N rows before `limit::` applies | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_offset_and_limit_page_the_result` |
| EC-2 | Offset past the end yields empty output, exit 0 — not an error | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_offset_and_limit_page_the_result` |
