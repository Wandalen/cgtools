...
| ID | Case | Real Test |
|----|------|-----------|
| EC-1 | Matching needle, mixed case, default insensitivity | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_pattern_matches_case_insensitively_by_default` |
| EC-2 | Same needle under `case::1` — no exact-case match, empty result, exit 0 | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::query_pattern_with_case_switch_demands_exact_case` |
