...
|----|----------|-----------|
| INT-1 | Direct call lists every distinct `group:tag` pair and its carrying chunk(s) | `shader_chunks_query_core/tests/shader_chunks_query_core_test.rs::list_tags_lists_every_distinct_group_tag_pair_and_its_chunks` |
