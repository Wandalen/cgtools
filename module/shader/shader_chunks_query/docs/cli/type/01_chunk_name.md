...
(`chunk_find` in `shader_chunks_query_core/src/lib.rs`) rather than a compile-time-distinct newtype.
...
**Parsing:** `chunk_find(name: &str)` (`shader_chunks_query_core/src/lib.rs`) resolves the name via
...
| 4 | [`.compose`](../../../../shader_chunks_compose/docs/cli/command/01_compose.md) | `names` |
| 5 | [`.tunables`](../../../../shader_chunks_params/docs/cli/command/01_tunables.md) | `name` |
