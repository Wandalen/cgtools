...
- **Out of Scope:** Parameter type/constraint detail (this crate's own
  → [`../param/`](../param/readme.md); `shader_chunks_query`-owned →
  [`names`](../../../../shader_chunks_query/docs/cli/param/02_names.md),
...
|---|------|---------|--------|--------|
| 1 | [01_compose.md](01_compose.md) | `.compose` | 3 | ✅ |
...
|---|---------|---------|--------|-------|
| 1 | `.compose` | Preview composed WGSL for the given chunks (or write it to a file with `out::`) | 3 | [Compose](../command_group/01_compose.md) |
