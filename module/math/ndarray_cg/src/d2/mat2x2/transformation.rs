...
#[ inline ]
pub fn rot< E >( angle_radians : E ) -> Mat2< E >
where
  E : MatEl + nd::NdFloat,
  Mat2< E > : RawSliceMut< Scalar = E >,
{
...
#[ inline ]
pub fn scale< E, Scaling >( scaling : Scaling ) -> Mat2< E >
where
  E : MatEl + nd::NdFloat,
...
#[ inline ]
pub fn shear< E, Shearing >( shearing : Shearing ) -> Mat2< E >
where
  E : MatEl + nd::NdFloat,
