//! Verifies `clean`'s attachment-id conversion ( `minwebgl::clean::convert_attachment_id` ) —
...
use minwebgl::{ clean::convert_attachment_id, WebglError };
...
///
/// ## Fix Applied
/// Extracted the conversion into a `convert_attachment_id` helper returning
