...
//@ export: fn sdf_op_intersect(d1: f32, d2: f32) -> f32
//@ export: fn sdf_op_intersect_preview(p: vec2f, circle_offset_x: f32, circle_radius: f32, box_offset_x: f32, box_half_extent: f32) -> f32
...
fn sdf_op_intersect( d1 : f32, d2 : f32 ) -> f32
{
  return max( d1, d2 );
}

fn sdf_op_intersect_preview( p : vec2f, circle_offset_x : f32, circle_radius : f32, box_offset_x : f32, box_half_extent : f32 ) -> f32
{
