...
//@ export: fn d2_sdf_equilateral_triangle_preview(p: vec2f, circumradius: f32) -> f32
...
fn d2_sdf_equilateral_triangle_preview( p : vec2f, circumradius : f32 ) -> f32
{
  return d2_sdf_equilateral_triangle( p, circumradius );
}
