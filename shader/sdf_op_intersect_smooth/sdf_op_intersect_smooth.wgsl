...
//@ export: fn sdf_op_intersect_smooth(d1: f32, d2: f32, k: f32) -> f32
//@ export: fn sdf_op_intersect_smooth_preview(p: vec2f, circle_offset_x: f32, circle_radius: f32, box_offset_x: f32, box_half_extent: f32, blend_radius: f32) -> f32
...
fn sdf_op_intersect_smooth( d1 : f32, d2 : f32, k : f32 ) -> f32
{
  let h = clamp( 0.5 - 0.5 * ( d2 - d1 ) / k, 0.0, 1.0 );
  return mix( d2, d1, h ) + k * h * ( 1.0 - h );
}

fn sdf_op_intersect_smooth_preview( p : vec2f, circle_offset_x : f32, circle_radius : f32, box_offset_x : f32, box_half_extent : f32, blend_radius : f32 ) -> f32
{
  ...
  return sdf_op_intersect_smooth( d1, d2, blend_radius );
}
