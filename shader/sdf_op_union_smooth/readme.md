...
| `export` | `fn sdf_op_union_smooth(d1: f32, d2: f32, k: f32) -> f32`, `fn sdf_op_union_smooth_preview(p: vec2f, circle_offset_x: f32, circle_radius: f32, box_offset_x: f32, box_half_extent: f32, blend_radius: f32) -> f32` |
